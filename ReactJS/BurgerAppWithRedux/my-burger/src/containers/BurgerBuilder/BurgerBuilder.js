        ...
        if(this.props.ings){
            burger=(
                <Aux>
                    ...
                    <BuildControls orderedNow={this.orderNowhandler} purchasable={this.state.purchasable} price={this.state.totalPrice} disabledInfo={disabledInfo}  addedIngredients={this.props.onIngredientAdded} removeIngredients={this.props.onIngredientRemoved} />
                </Aux>
            )
            orderSummery= <OrderSummery totalPrice={this.state.totalPrice} cancelHander={this.ModalClosedHandler} continueHander={this.ContinueOrderHandler} ingredients={this.props.ings}></OrderSummery>
        }
        if(this.state.error){
